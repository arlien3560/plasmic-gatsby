...
import * as sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: Iwcc17VazkXsyE/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__q8Dxt)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__ip03)}>
            <h5
