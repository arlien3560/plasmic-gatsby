...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: x_Bemi_ddgAdp_/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__dAzWm)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__butXx)}
                role={"img"}
              />
            ),
