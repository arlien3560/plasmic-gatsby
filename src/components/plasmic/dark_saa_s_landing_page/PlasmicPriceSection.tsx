...
import * as sty from "./PlasmicPriceSection.module.css"; // plasmic-import: xRx78yWhQ5mM4n/css
    ...
    >
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__aNbMy)}
        >
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__tNUdP)}>
              <PriceCard
                borders={["flatLeft"]}
                className={classNames("__wab_instance", sty.priceCard__an2Ft)}
              />
            </div>
          ) : null}
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__sFeci)}>
              <div className={classNames(projectcss.all, sty.freeBox__qgod)}>
                <div
              ...
              {(
                ...
                <PriceCard
                  borders={["flatCenter"]}
                  className={classNames("__wab_instance", sty.priceCard__veJin)}
                />
              ) : null}
            </div>
          ) : null}
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__yXiQn)}>
              <PriceCard
                borders={
                ...
                className={classNames("__wab_instance", sty.priceCard__rvDjZ)}
              />
            </div>
          ) : null}
        </p.Stack>
